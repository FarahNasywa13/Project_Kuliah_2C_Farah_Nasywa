                ...
                <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                  ...
                  <div class="col-lg-12">
                    ...
                    if ($row['username'] == $_SESSION['username_decafe']) {
                      ...
                      echo "Apakah anda yakin ingin mereset password 
                                            <b> $row[username]</b> menjadi password bawaan sistem <b>password</b>";
                    }
                    ?>
              ...
              ?>
                <tr>
                  ...
                  <td class="d-flex">
                    ...
                    <button class="btn btn-danger btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id'] ?>"><i class="bi bi-trash3"></i></i></button>
                    <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#ModalResetPassword<?php echo $row['id'] ?>"><i class="bi bi-arrow-repeat"></i></i></button>
                  </td>
                </tr>
              <?php
              }
