...
<head>
    ...
    <title>Perabot ud.fajar - Aplikasi Penjualan online produk perabotan rumah tangga</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
        <button class="btn btn-bd-dark py-2 dropdown-toggle d-flex align-items-center" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" aria-label="Toggle theme (auto)">
